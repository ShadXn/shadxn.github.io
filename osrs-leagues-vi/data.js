  ...
  },
  {
    ...
    relics: [
      ...
      },
      {
        ...
        name: 'Executioner',
        column: 3,
        icon: 'images/relices/relic_executioner_t8_icon.png',
        image: 'images/relices/relic_executioner_t8.png',
        wikiUrl: `${WIKI}Executioner_(Demonic_Pacts_League)`,
        gift: "Sage's Axe",
        toggleable: null,
        effects: [
          'The <strong>Sage\'s Axe</strong> is a thrown ranged weapon which can be used to <strong>execute targets below 20% hitpoints</strong>.',
          'The axe has an <strong>attack range of 6 tiles</strong>.',
          'The axe\'s damage respects any ranged damage reduction effects and immunities the target has.',
          'The axe will <strong>not work against Yama</strong>.',
          'Throwing the axe doesn\'t consume it, but the primary hit does trigger regeneration effects from Demonic Pacts.',
          'Execute damage can hit <strong>additional targets</strong> with Demonic Pacts.',
          'This perk will also work <strong>inside The Gauntlet</strong>.',
